...
const AddStudent = () => {
  ...
  const handleSubmit=async ()=>{
    try {
      if(!regNo){
        const res=await axios.post('http://localhost:6555/api/student/create',student)
        console.log(res);
      }else{
        const res=await axios.put(`http://localhost:6555/api/student/${regNo}`,student)
        console.log(res);
      }
      // console.log(student)
    } catch (error) {
                    ...
                    <div className="row row-cols-xxl-5 row-cols-md-6">
                      ...
                      <div className="col-xxl col-xl-3 col-md-6">
                        <div className="mb-3">
                          ...
                          <input type="text" className="form-control" defaultValue={isEdit? student.regNo: undefined} 
                            onChange={(e)=>{
                              setStudent((prev)=>({
                                ...prev,
                        ...
                        <div className="mb-3">
                          ...
                          {isEdit? <DatePicker
                              ...
                              onChange={(date:moment.Moment | null)=>{
                                setStudent((prev)=>({
                                ...prev,
                                  joinedOn:date? date.format("DD-MM-YYYY"): ""
                                }))
                              }}
                            />}
                      ...
                      <div className="col-xxl col-xl-3 col-md-6">
                        <div className="mb-3">
                          ...
                          <input type="text" className="form-control" defaultValue={isEdit? student.rollNo: undefined} 
                          onChange={(e)=>{
                            setStudent((prev)=>({
                              ...prev,
                      ...
                      <div className="col-xxl col-xl-3 col-md-6">
                        <div className="mb-3">
                          ...
                          <CommonSelect
                            className="select"
                            options={status}
                            defaultValue={isEdit?status.find(item=>item.value===student.status):undefined}
                            onChange={(option)=>{
                              setStudent((prev)=>({
                                ...prev,
                      ...
                      <div className="col-xxl col-xl-3 col-md-6">
                        <div className="mb-3">
                          ...
                          <input type="text" className="form-control" defaultValue={isEdit? student.firstName: undefined}
                          onChange={(e)=>{
                            setStudent((prev)=>({
                              ...prev,
                      ...
                      <div className="col-xxl col-xl-3 col-md-6">
                        <div className="mb-3">
                          ...
                          <input type="text" className="form-control" defaultValue={isEdit? student.lastName: undefined}
                          onChange={(e)=>{
                            setStudent((prev)=>({
                              ...prev,
                      ...
                      <div className="col-xxl col-xl-3 col-md-6">
                        <div className="mb-3">
                          ...
                          <CommonSelect
                            className="select"
                            options={allClass}
                            defaultValue={isEdit?allClass.find(classes=>classes.value===student.class):undefined}
                            onChange={(option)=>{
                              setStudent((prev)=>({
                                ...prev,
                      ...
                      <div className="col-xxl col-xl-3 col-md-6">
                        <div className="mb-3">
                          ...
                          <CommonSelect
                            className="select"
                            options={allSection}
                            defaultValue={isEdit?allSection.find(sec=>sec.value===student.section):undefined}
                            onChange={(option)=>{
                              setStudent((prev)=>({
                                ...prev,
                      ...
                      <div className="col-xxl col-xl-3 col-md-6">
                        <div className="mb-3">
                          ...
                          <CommonSelect
                            className="select"
                            options={gender}
                            defaultValue={isEdit?gender.find(gen=>gen.value===student.gender):undefined}
                            onChange={(option)=>{
                              setStudent((prev)=>({
                                ...prev,
        ...
        >
          ...
          Add New
                ...
                <div className="text-end">
                  ...
                  <Link to={routes.studentList} className="btn btn-primary" onClick={handleSubmit}>
