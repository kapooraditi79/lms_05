...
const StudentGrid = () => {
    ...
    const [student, setStudent] = useState<Student[]>([{
      ...
      section: "",
      status: "Active",
      profileImage: "assets/img/students/student-01.jpg",
    }]);
    ...
    const fetchStudent = async () => {
      try {
        const res=await axios.get('http://localhost:6555/api/student')
        setStudent(res.data)
          ...
          student.map((item)=>(
            ...
            <div className="card flex-fill">
              <div className="card-header d-flex align-items-center justify-content-between">
                <Link to={`${routes.student}/${item.regNo}`} className="link-primary">
                  {item.regNo}
                </Link>
              ...
              <div className="card-body">
                <div className="bg-light-300 rounded-2 p-3 mb-3">
                  <div className="d-flex align-items-center">
                    ...
                    <div className="ms-2">
                      <h5 className="mb-0">
                        <Link to={`${routes.student}/${item.regNo}`}>{item.firstName}</Link>
                      </h5>
                ...
                <div className="d-flex align-items-center justify-content-between gx-2">
                  <div>
                    ...
                    <p className="text-dark">{item.rollNo}</p>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <p className="text-dark">{item.joinedOn}</p>
                  </div>
                </div>
              </div>
