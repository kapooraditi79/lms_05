...
const StudentDetails = () => {
  ...
  const { regNo } = useParams(); // Get the regNo from the URL
  const [student, setStudent] = useState(null); //State to hold the student details
  const [loading, setloading] = useState(true);
  const [error, setError] = useState(null);

  //Fetch student data when component mounts or regNo changes
  useEffect(() => {
    ...
    <>
      ...
      <div className="page-wrapper">
        <div className="content">
          <div className="row">
            {/* Page Header */}
            <StudentBreadcrumb regNo={regNo} />
            {/* /Page Header */}
          </div>
          <div className="row">
            {/* Student Information */}
            <StudentSidebar regNo={regNo} />
            {/* /Student Information */}
