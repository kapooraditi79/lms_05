...
$(document).ready(function () {
	...
	if ($('.comming-soon-pg').length > 0) {
		...
		function setCountdown() {
			...
			// Set countdown date
			let countdownDate = new Date('jul 30, 2024 16:00:00').getTime();
...
$(document).ready(function () {
	// Add mini-sidebar class on click
	$('#layout-mini').click(function () {
		$('body').toggleClass('mini-sidebar');
	});

	// Add expand-menu class on hover
	$('#sidebar').hover(
		function () {
			$('body').addClass('expand-menu');
		},
...
$(function() {
	if (window.location.pathname.includes('/layout-dark')) {
